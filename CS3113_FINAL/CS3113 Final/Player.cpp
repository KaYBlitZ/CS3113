...
const float Player::X_ACCEL = 0.6f;

Player::Player() : collideLeft(false), collideTop(false), collideRight(false), collideBottom(false) {}
Player::Player(float x, float y, SheetSprite sprite) : Entity(x, y), collideLeft(false), collideTop(false), collideRight(false), collideBottom(false) {}
